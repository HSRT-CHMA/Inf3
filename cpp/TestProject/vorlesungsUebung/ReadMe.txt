========================================================================
    KONSOLENANWENDUNG: vorlesungsUebung-Projektübersicht
========================================================================

Diese vorlesungsUebung-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre vorlesungsUebung-Anwendung besteht.


vorlesungsUebung.vcxproj
...
vorlesungsUebung.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen vorlesungsUebung.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
